...
{
	public class MapRoutePage : ContentPage
	{
		public MapRoutePage ()
		{
			...
			var position = new Position (37.790228, -122.400391); // Latitude, Longitude
			var pin = new Pin {
				Type = PinType.Place,
				Position = position,
				Label = "Santa Cruz",
			...
			var position1 = new Position (37.785983, -122.397295); // Latitude, Longitude
			var pin1 = new Pin {
				Type = PinType.Place,
				Position = position1,
				Label = "Santa Cruz",
